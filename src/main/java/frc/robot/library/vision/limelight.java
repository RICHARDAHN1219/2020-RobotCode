...
public class limelight {
  ...
  private static NetworkTable limelightNT;
   ...
   * the target.
   * 
   * @param targetHeight= target height in meters, limelightHeight = height of
   *                      limelight from the ground in meters, limelightAngle =
   *                      angle in degrees of the limelight on the robot.
   * @return approx distance in meters
   */
  public static double getDist(double targetHeight, double limelightHeight, double limelightAngle) {
      double a2 = getTY();
