...
public class linearInterpolator {
     ...
     * 
     * If the value of x is not in the table, the closest two values of x are chosen and the value
     * of y returned is interpolated between the corresponding y values.
     * 
     * If the value of x is greater than max x value, the corresponding value of y for max x is
     * returned. If the value of x is less than the min x value, the corresponding value of y for
     * the min x is returned.
     *
    ...
    public double getInterpolatedValue(double x) {
        ...
        // TODO: this uses linear search, for larger tables (>5), binary search would be faster
        int index = 0;
